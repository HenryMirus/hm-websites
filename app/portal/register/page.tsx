        ...
        <div className="w-full max-w-sm">
          ...
          <div className="bg-surface border border-border rounded-2xl p-8 text-center">
            ...
            <p className="text-text-dim text-sm mb-6">
              Der Einladungs-Link ist entweder abgelaufen (15 Minuten) oder wurde bereits
              verwendet. Bitte im Portal eine neue Einladung anfordern lassen.
            </p>
            <a
              href="/login"
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-text-dim text-xs mt-0.5">
                Konto einrichten für <span className="text-primary font-mono">{user.email}</span>
              </p>
            </div>
          </div>
