 ...
 *       erscheinen deshalb OHNE Preisspanne („klärt Henry persönlich").
 *
...
export const PREIS_DISCLAIMER: I18n = {
  de: "Das ist eine unverbindliche Orientierung basierend auf vergleichbaren Projekten — kein Angebot. Ein konkretes, verbindliches Angebot erstellt Henry erst nach einem persönlichen Gespräch, in dem die genauen Anforderungen geklärt werden.",
  en: "This is a non-binding orientation based on comparable projects — not an offer. Henry only prepares a specific, binding quote after a personal conversation in which the exact requirements are clarified.",
};
...
export const LEISTUNGEN: Leistung[] = [
  ...
  /* ————— TEIL B — KI-LEISTUNGEN ————— */
  {
    ...
    kurz: {
      de: "Beantwortet Besucherfragen und leitet qualifizierte Anfragen weiter — auf EU-Servern, ohne Drittanbieter.",
      en: "Answers visitor questions and forwards qualified leads — on EU servers, no third parties.",
    },
    beschreibung: {
      de: "Ein KI-Assistent auf Ihrer Website, der Besucherfragen beantwortet, Preisorientierung gibt und qualifizierte Anfragen weiterleitet — vollständig auf EU-Servern betrieben, ohne Datenweitergabe an OpenAI, Google oder andere Drittanbieter.",
      en: "An AI assistant on your website that answers visitor questions, gives price orientation and forwards qualified inquiries — operated entirely on EU servers, with no data passed to OpenAI, Google or any other third party.",
    },
    fuerWen: {
  ...
  },
  {
    ...
    fuerWen: {
      ...
      en: "Online shops, booking systems, customer portals in B2C. Honest classification: micro-enterprises are exempt for services — we tell you that first.",
    },
    enthalten: {
      de: [
  ...
  },
  {
    ...
    beschreibung: {
      de: "Eine eigene, private KI-Umgebung auf Ihrem Server — wie ChatGPT, nur dass kein einziges Byte das Unternehmen verlässt. Mitarbeiter fassen Verträge zusammen, entwerfen E-Mails, durchsuchen interne Dokumente — DSGVO-konform ohne US-Anbieter.",
      en: "Your own private AI environment on your server — like ChatGPT, except not a single byte leaves the company. Staff summarise contracts, draft emails, search internal documents — GDPR-compliant without US providers.",
    },
    fuerWen: {
...
/** Wartungs-Tarife im Detail (preislogik.yaml wartung.tiers) — für /preise */
